        ...
        <div className="h-screen w-screen flex flex-col justify-center items-center bg-white dark:bg-slate-800">
            ...
            <form className="w-full max-w-md">
                <div className="relative">
                    <input type="text"
                        className="rounded w-full p-3 pl-10 text-sm text-gray-700 text-lg "
            ...
            <button class="bg-red-700 hover:bg-red-500 text-white font-bold mt-2 py-2 px-4 rounded-full inline-flex items-center">
